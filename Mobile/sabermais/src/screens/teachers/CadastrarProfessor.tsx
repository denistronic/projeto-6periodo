...
export function CadastrarProfessor() {
  ...
  const handleNext = () => {
    console.log('Próximo passo do cadastro de professor:', {
      nome,
      email,
      senha,
      confirmarSenha,
    });
    // depois você pode navegar para Etapa 2, por exemplo:
    // navigation.navigate('CadastroProfessorEtapa2');
  };

  const handleGoLogin = () => {
    // Volta para a tela Login dentro do PerfilStack
